...
class PlaylistFeature {
    ...
    fun displayListOfPlaylist() {
        ...
        onView(allOf(withId(R.id.tvPlaylist), isDescendantOfA(nthChildOf(withId(R.id.rvPlaylist), 0))))
            .check(matches(withText("Hard Rock Cafe")))
            .check(matches(isDisplayed()))

        // Check the category of first item in the playlist
        onView(allOf(withId(R.id.tvCategory), isDescendantOfA(nthChildOf(withId(R.id.rvPlaylist), 0))))
